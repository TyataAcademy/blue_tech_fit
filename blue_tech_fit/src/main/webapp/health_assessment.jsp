				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							<h1 class="text-white">
								My Holistic Health Assessment				
							</h1>	
							<p class="text-white link-nav"><a href="index.jsp">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="health_assessment.jsp"> My Holistic Health Assessment</a></p>
						</div>	
					</div>
				</div>
			</section>
